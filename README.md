...
## Data
  ...
  The main issues with our data was that it was heavily imbalanced. We had more crime and drama movies than for example animation. While this makes intuitive sense, this did impact our analysis. Also a major factor we failed to take into account for was time. A horror poster in the 1990’s would be different to one say in 2020. Another issue was that it's very hard to pin down movies as one genre. We have action comedies and drama and crime all together showcased in one movie, which is something hard to make a classifier for. We ran into these issues when we made the classifier as well. Our future plans include making a CNN that can actually reshape and classify the images based on their pixels instead of looking at their mean value features.
...
![Sci-Fi: Value vs Saturation](https://github.com/ucsd-dsc-arts/dsc160-midterm-group-11/blob/master/images/SCIFI_VALUE_VS_SATURATION.jpg)
**Drama: Value vs Hue**
![Drama: Value vs Hue](https://github.com/ucsd-dsc-arts/dsc160-midterm-group-11/blob/master/images/drama-bitmap-value-vs-hue.jpg)
**Drama: Value vs Saturation**
![Drama: Value vs Saturation](https://github.com/ucsd-dsc-arts/dsc160-midterm-group-11/blob/master/images/drama-bitmap-value-vs-saturation.jpg)
**Fantasy: Value vs Hue**
